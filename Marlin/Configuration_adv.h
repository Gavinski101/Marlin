...
#define HOMING_BUMP_DIVISOR { 5, 5, 4 }//{ 2, 2, 4 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)
 ...
 */
  ...
  #define PROBING_MARGIN_LEFT   15//PROBING_MARGIN
  #define PROBING_MARGIN_RIGHT  92//PROBING_MARGIN
  #define PROBING_MARGIN_FRONT  15//PROBING_MARGIN
  #define PROBING_MARGIN_BACK   37//PROBING_MARGIN
#endif
